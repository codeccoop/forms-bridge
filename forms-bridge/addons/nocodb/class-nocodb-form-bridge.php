...
/**
 * Form bridge implementation for the NocoDB service.
 */
class NocoDB_Form_Bridge extends Form_Bridge {
	...
	public function __construct( $data ) {
		parent::__construct( $data, 'nocodb' );
	}
	...
	/**
	 * Fetches the fields of the NocoDB table and returns them as an array.
	 *
